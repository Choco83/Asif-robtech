...
int main(int argc, char **argv)
{
  ...
  ROS_INFO("Visualizing plan 1 (down) %s",success?"":"FAILED");
  ...
  ROS_INFO("Visualizing plan 2 (right) %s",success?"":"FAILED");
  ...
  ROS_INFO("Visualizing plan 3 (start_pos) %s",success?"":"FAILED");
